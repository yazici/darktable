...
#  gr.add_edge(('liqres_eh', 'vignette'))
  ...
  # don't indicate liqres_eh as over/under exposed
#  gr.add_edge(('liqres_eh', 'overexposed'))
#  gr.add_edge(('liqres_eh', 'rawoverexposed')) # can, but no need to
  # don't resample liqres_eh when scaling to the output dimensions
#  gr.add_edge(('liqres_eh', 'finalscale'))
