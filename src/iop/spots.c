...
{
  dt_accel_register_iop (module, FALSE, NC_("accel", "spot circle tool"),   0, 0);
  dt_accel_register_iop (module, FALSE, NC_("accel", "spot elipse tool"),   0, 0);
  dt_accel_register_iop (module, FALSE, NC_("accel", "spot path tool"),     0, 0);
}
