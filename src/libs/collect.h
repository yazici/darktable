...
const char *dt_lib_collect_string[]
    = { N_("film roll"), N_("folders"),   N_("camera"),      N_("tag"),       N_("date"),
        N_("time"),      N_("history"),   N_("color label"), N_("title"),     N_("description"),
        N_("creator"),   N_("publisher"), N_("rights"),      N_("lens"),      N_("focal length"),
        N_("ISO"),       N_("aperture"),  N_("filename"),    N_("geotagging") };
