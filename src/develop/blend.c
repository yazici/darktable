...
typedef void (_blend_row_func)(dt_iop_colorspace_type_t cst,const gboolean use_mask,const float opacity,const float *a, float *b,int stride, int flag);
...
/* normal blend */
static void _blend_normal(dt_iop_colorspace_type_t cst,const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  float ta[3], tb[3];
...
/* lighten */
static void _blend_lighten(dt_iop_colorspace_type_t cst,const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  int channels = _blend_colorspace_channels(cst);
  float ta[3], tb[3], tbo;
...
/* darken */
static void _blend_darken(dt_iop_colorspace_type_t cst,const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  int channels = _blend_colorspace_channels(cst);
  float ta[3], tb[3], tbo;
  float max[4]={0},min[4]={0};
...
/* multiply */
static void _blend_multiply(dt_iop_colorspace_type_t cst,const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  float ta[3], tb[3];
  int channels = _blend_colorspace_channels(cst);
  float max[4]={0},min[4]={0};
...
/* average */
static void _blend_average(dt_iop_colorspace_type_t cst,const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  float ta[3], tb[3];
  int channels = _blend_colorspace_channels(cst);
  float max[4]={0},min[4]={0};
...
/* add */
static void _blend_add(dt_iop_colorspace_type_t cst,const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  float ta[3], tb[3];
  int channels = _blend_colorspace_channels(cst);
  float max[4]={0},min[4]={0};
...
/* substract */
static void _blend_substract(dt_iop_colorspace_type_t cst, const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  float ta[3], tb[3];
  int channels = _blend_colorspace_channels(cst);
  float max[4]={0},min[4]={0};
...
/* difference */
static void _blend_difference(dt_iop_colorspace_type_t cst, const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  float ta[3], tb[3];
  int channels = _blend_colorspace_channels(cst);
  float max[4]={0},min[4]={0};
...
/* screen */
static void _blend_screen(dt_iop_colorspace_type_t cst, const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  float ta[3], tb[3];
  int channels = _blend_colorspace_channels(cst);
  float max[4]={0},min[4]={0};
...
/* overlay */
static void _blend_overlay(dt_iop_colorspace_type_t cst, const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  float ta[3], tb[3];
  int channels = _blend_colorspace_channels(cst);
  float max[4]={0},min[4]={0};
...
/* softlight */
static void _blend_softlight(dt_iop_colorspace_type_t cst, const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  float ta[3], tb[3];
  int channels = _blend_colorspace_channels(cst);
  float max[4]={0},min[4]={0};
...
/* hardlight */
static void _blend_hardlight(dt_iop_colorspace_type_t cst, const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  float ta[3], tb[3];
  int channels = _blend_colorspace_channels(cst);
  float max[4]={0},min[4]={0};
...
/* vividlight */
static void _blend_vividlight(dt_iop_colorspace_type_t cst, const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  float ta[3], tb[3];
  int channels = _blend_colorspace_channels(cst);
  float max[4]={0}, min[4]={0};
...
/* linearlight */
static void _blend_linearlight(dt_iop_colorspace_type_t cst, const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  float ta[3], tb[3];
  int channels = _blend_colorspace_channels(cst);
  float max[4]={0},min[4]={0};
...
/* pinlight */
static void _blend_pinlight(dt_iop_colorspace_type_t cst, const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  float ta[3], tb[3];
  int channels = _blend_colorspace_channels(cst);
  float max[4]={0},min[4]={0};
...
/* lightness blend */
static void _blend_lightness(dt_iop_colorspace_type_t cst,  const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  float ta[3], tb[3];
  float tta[3], ttb[3];
  int channels = _blend_colorspace_channels(cst);
...
/* chroma blend */
static void _blend_chroma(dt_iop_colorspace_type_t cst, const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  float ta[3], tb[3];
  float tta[3], ttb[3];
  int channels = _blend_colorspace_channels(cst);
...
/* hue blend */
static void _blend_hue(dt_iop_colorspace_type_t cst, const gboolean use_mask,const float opacity,const float *a, float *b,int stride, int flag)
{
  float ta[3], tb[3];
  float tta[3], ttb[3];
  int channels = _blend_colorspace_channels(cst);
...
static void _blend_color(dt_iop_colorspace_type_t cst, const gboolean use_mask, const float opacity,const float *a, float *b,int stride, int flag)
{
  float ta[3], tb[3];
  float tta[3], ttb[3];
  int channels = _blend_colorspace_channels(cst);
...
#ifdef _OPENMP
#pragma omp parallel for default(none) shared(ch,use_mask, in,roi_out,out,blend,d)
#endif
  for (int y=0; y<roi_out->height; y++) {
    int index = (ch*y*roi_out->width);
    blend(cst, use_mask, opacity, in+index, out+index, roi_out->width*ch, blendflag);
  }
