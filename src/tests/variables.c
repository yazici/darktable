...
static const test_t test_simple_substitutions = { "abcdef12345abcdef",
                                                  "ABCDEF12345ABCDEF",
                                                  23,
...
static const test_t test_broken_variables = { "abcdef12345abcdef",
                                              "ABCDEF12345ABCDEF",
                                              23,
...
{
  char *argv[]
      = { "darktable-test-variables", "--library", ":memory:", "--conf", "write_sidecar_files=FALSE", NULL };
  ...
  printf("%d / %d tests failed (%d / %d)\n", n_failed_overall, n_tests_overall, n_test_functions_failed,
         n_test_functions);
