...
void dt_control_init(dt_control_t *s)
{
  ...
  if(rc == SQLITE_OK && sqlite3_step(stmt) == SQLITE_ROW)
  {
    ...
    else
    {
      ...
      sqlite3_exec(dt_database_get(darktable.db), "alter table images add column masks varchar", NULL, NULL, NULL);
